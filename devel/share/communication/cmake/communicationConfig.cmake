...
if("TRUE" STREQUAL "TRUE")
  set(communication_SOURCE_PREFIX /home/dtrobot/robot/src/communication)
  set(communication_DEVEL_PREFIX /home/dtrobot/robot/devel)
  ...
  set(communication_INSTALL_PREFIX /home/dtrobot/robot/install)
...
if(NOT "/home/dtrobot/robot/devel/include " STREQUAL " ")
  set(communication_INCLUDE_DIRS "")
  set(_include_dirs "/home/dtrobot/robot/devel/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'communication' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'dtrobot <dtrobot@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'communication' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/dtrobot/robot/src/communication/${idir}'.  Ask the maintainer 'dtrobot <dtrobot@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/dtrobot/robot/devel/lib;/home/dtrobot/robot/devel/lib;/home/dtrobot/car/devel/lib;/home/dtrobot/DetectRobot/devel/lib;/home/dtrobot/catkin_ws/devel/lib;/home/dtrobot/detectrobot/devel/lib;/opt/ros/indigo/lib)
...
set(communication_EXPORTED_TARGETS "communication_generate_messages_cpp;communication_generate_messages_lisp;communication_generate_messages_py")
