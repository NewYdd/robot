...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'communication' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/dtrobot/robot/install/${idir}'.  Ask the maintainer 'dtrobot <dtrobot@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/dtrobot/robot/install/lib;/home/dtrobot/robot/devel/lib;/home/dtrobot/car/devel/lib;/home/dtrobot/DetectRobot/devel/lib;/home/dtrobot/catkin_ws/devel/lib;/home/dtrobot/detectrobot/devel/lib;/opt/ros/indigo/lib)
